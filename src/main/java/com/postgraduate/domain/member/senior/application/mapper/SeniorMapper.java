package com.postgraduate.domain.member.senior.application.mapper;
...
import com.postgraduate.domain.member.senior.domain.entity.constant.Field;
import com.postgraduate.domain.member.senior.domain.entity.constant.Postgradu;
...
import com.postgraduate.domain.member.senior.application.dto.res.AvailableTimeResponse;
...
public class SeniorMapper {
    ...
    public static SeniorDetailResponse mapToSeniorDetail(Senior senior, List<AvailableTimeResponse> times, boolean isMine) {
        ...
        if (senior.getProfile() != null) {
            ...
            return new SeniorDetailResponse(
                    isMine,
                    senior.getStatus().equals(Status.APPROVE),
    ...
    public static SeniorSearchResponse mapToSeniorSearchWithStatus(Senior senior) {
        ...
        return new SeniorSearchResponse(senior.getSeniorId(), senior.getStatus().equals(Status.APPROVE),user.getProfile(), user.getNickName(),
