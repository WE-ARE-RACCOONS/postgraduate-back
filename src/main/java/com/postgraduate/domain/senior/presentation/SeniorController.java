...
public class SeniorController {
    ...
    public ResponseEntity<ResponseDto<AllSeniorIdResponse>> getAllSeniorId() {
        ...
        return ResponseEntity.ok(create(SENIOR_FIND.getCode(), GET_SENIOR_ID_LIST.getMessage(), seniorIds));
    }
    ...
    public ResponseEntity<ResponseDto<Void>> updateCertification(@AuthenticationPrincipal User user,
        ...
        return ResponseEntity.ok(create(SENIOR_UPDATE.getCode(), UPDATE_CERTIFICATION.getMessage()));
    }
    ...
    public ResponseEntity<ResponseDto<SeniorProfileUpdateResponse>> singUpSenior(@AuthenticationPrincipal User user,
        ...
        return ResponseEntity.ok(create(SENIOR_UPDATE.getCode(), UPDATE_PROFILE.getMessage(), updateResponse));
    }
    ...
    public ResponseEntity<ResponseDto<Void>> updateAccount(@AuthenticationPrincipal User user,
        ...
        return ResponseEntity.ok(create(SENIOR_CREATE.getCode(), CREATE_ACCOUNT.getMessage()));
    }
    ...
    public ResponseEntity<ResponseDto<SeniorMyPageResponse>> getSeniorInfo(@AuthenticationPrincipal User user) {
        ...
        return ResponseEntity.ok(create(SENIOR_FIND.getCode(), GET_SENIOR_INFO.getMessage(), seniorMyPageResponse));
    }
    ...
    public ResponseEntity<ResponseDto<SeniorMyPageProfileResponse>> getSeniorProfile(@AuthenticationPrincipal User user) {
        ...
        return ResponseEntity.ok(create(SENIOR_FIND.getCode(), GET_SENIOR_MYPAGE_PROFILE.getMessage(), myPageProfile));
    }
    ...
    public ResponseEntity<ResponseDto<SeniorProfileUpdateResponse>> updateSeniorProfile(@AuthenticationPrincipal User user,
        ...
        return ResponseEntity.ok(create(SENIOR_UPDATE.getCode(), UPDATE_MYPAGE_PROFILE.getMessage(), updateResponse));
    }
    ...
    public ResponseEntity<ResponseDto<SeniorMyPageUserAccountResponse>> getSeniorUserAccount(@AuthenticationPrincipal User user) {
        ...
        return ResponseEntity.ok(create(SENIOR_FIND.getCode(), GET_SENIOR_MYPAGE_ACCOUNT.getMessage(), seniorOriginInfo));
    }
    ...
    public ResponseEntity<ResponseDto<Void>> updateSeniorUserAccount(@AuthenticationPrincipal User user,
        ...
        return ResponseEntity.ok(create(SENIOR_UPDATE.getCode(), UPDATE_MYPAGE_ACCOUNT.getMessage()));
    }
    ...
    public ResponseEntity<ResponseDto<SeniorDetailResponse>> getSeniorDetails(@AuthenticationPrincipal User user,
        ...
        return ResponseEntity.ok(create(SENIOR_FIND.getCode(), GET_SENIOR_INFO.getMessage(), seniorDetail));
    }
    ...
    public ResponseEntity<ResponseDto<SeniorProfileResponse>> getSeniorProfile(@AuthenticationPrincipal User user, @PathVariable Long seniorId) {
        ...
        return ResponseEntity.ok(create(SENIOR_FIND.getCode(), GET_SENIOR_INFO.getMessage(), seniorProfile));
    }
    ...
    public ResponseEntity<ResponseDto<AvailableTimesResponse>> getSeniorTimes(@PathVariable Long seniorId) {
        ...
        return ResponseEntity.ok(create(SENIOR_FIND.getCode(), GET_SENIOR_TIME.getMessage(), times));
    }
    ...
    public ResponseEntity<ResponseDto<AllSeniorSearchResponse>> getSearchSenior(@RequestParam String find,
        ...
        return ResponseEntity.ok(create(SENIOR_FIND.getCode(), GET_SENIOR_LIST_INFO.getMessage(), searchSenior));
    }
    ...
    public ResponseEntity<ResponseDto<SeniorPossibleResponse>> checkRole(@AuthenticationPrincipal User user) {
        ...
        return ResponseEntity.ok(create(SENIOR_FIND.getCode(), GET_USER_CHECK.getMessage(), possibleResponse));
    }
}
