package com.postgraduate.domain.senior.salary.presentation;
...
public class SalaryController {
    ...
    public ResponseEntity<ResponseDto<SalaryInfoResponse>> getSalary(@AuthenticationPrincipal User user) {
        ...
        return ResponseEntity.ok(create(SalaryResponseCode.SALARY_FIND.getCode(), SalaryResponseMessage.GET_SALARY_INFO.getMessage(), salary));
    }
    ...
    public ResponseEntity<ResponseDto<SalaryDetailsResponse>> getWaitingSalary(@AuthenticationPrincipal User user) {
        ...
        return ResponseEntity.ok(create(SalaryResponseCode.SALARY_FIND.getCode(), SalaryResponseMessage.GET_SALARY_LIST_INFO.getMessage(), salary));
    }
