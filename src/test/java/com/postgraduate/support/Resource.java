...
public class Resource {
    ...
    private Wish wish = new Wish(-1L, "major", "field", true, user, com.postgraduate.domain.user.wish.domain.entity.constant.Status.WAITING);
    ...
    private Mentoring doneMentoring = new Mentoring(-3L, user, senior, payment, salary, "topic", "question", "2024-02-03-18-12", 30, MentoringStatus.DONE, now(), now());
