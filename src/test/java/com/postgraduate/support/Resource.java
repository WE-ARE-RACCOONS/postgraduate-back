...
public class Resource {
    ...
    private Wish wish = new Wish(-1L, "major", "field", "professor", "lab", "123", com.postgraduate.domain.wish.domain.entity.constant.Status.WAITING, now(), now());
    ...
    private Senior otherSenior = new Senior(-3L, otherUser, "certification", Status.WAITING, 0, 0, info, null, now(), now(), null, null);
    ...
    private Mentoring waitingMentoring = new Mentoring(-1L, user, senior, payment, salary, "topic", "question", "date1,date2,date3", 30, WAITING, now(), now(), null);
    private Mentoring expectedMentoring = new Mentoring(-2L, user, senior, payment, salary, "topic", "question", "date", 30, EXPECTED, now(), now(), null);
    private Mentoring doneMentoring = new Mentoring(-3L, user, senior, payment, salary, "topic", "question", "2024-02-03-18-12", 30, MentoringStatus.DONE, now(), now(), null);
