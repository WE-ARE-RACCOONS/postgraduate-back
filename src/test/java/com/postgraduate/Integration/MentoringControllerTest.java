...
//        Mentoring mentoring = new Mentoring(-1L, user, senior, payment, salary, "topic", "question", "date", 40, mentoringStatus, now(), now(), null);
...
//        Mentoring mentoring = new Mentoring(-1L, user, senior, payment, null, "topic", "question", "date", 40, MentoringStatus.EXPECTED, now(), now(), null);
//        mentoringRepository.save(mentoring);
//
...
//        Mentoring mentoring = new Mentoring(-1L, user, senior, payment, null, "topic", "question", "date", 40, mentoringStatus, now(), now(), null);
//        mentoringRepository.save(mentoring);
//
...
//        Mentoring mentoring = new Mentoring(-1L, otherUser, senior, payment, null, "topic", "question", "date", 40, MentoringStatus.EXPECTED, now(), now(), null);
//        mentoringRepository.save(mentoring);
//
//        mvc.perform(get("/mentoring/me/{mentoringId}", mentoring.getMentoringId())
//                        .header(AUTHORIZATION, BEARER + userAccessToken))
...
//        Mentoring mentoring = new Mentoring(-1L, otherUser, otherSenior, payment, null, "topic", "question", "date", 40, MentoringStatus.EXPECTED, now(), now(), null);
//        mentoringRepository.save(mentoring);
//
//        mvc.perform(get("/mentoring/senior/me/{mentoringId}", mentoring.getMentoringId())
//                        .header(AUTHORIZATION, BEARER + userAccessToken))
...
//        Mentoring mentoring = new Mentoring(-1L, user, senior, payment, null, "topic", "question", "2024-04-18-18-00,2024-04-18-18-00,2024-04-18-18-00", 40, MentoringStatus.WAITING, now(), now(), null);
//        mentoringRepository.save(mentoring);
//
...
//        Mentoring mentoring = new Mentoring(-1L, user, senior, payment, null, "topic", "question", "date1,date2,date3", 40, MentoringStatus.WAITING, now(), now(), null);
//        mentoringRepository.save(mentoring);
//
